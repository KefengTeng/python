    ...
    with open(r'/root/tengkf/logs/' + filename, 'a') as final:
        ...
        with open('ip.txt') as f:
            ...
            for line in f:
                ...
                # Send data to the channel
                channel.send("display ip routing-table {}\n".format(circuit_Ip))
                ...
                print(buff)
                sr_Dict.setdefault(buff.split('\r\n')[-2].split()[-2], []).append([circuit_Code, circuit_Name, circuit_Ip, circuit_Bandwidth])
        ...
        for sr_Ip, user_Info in sr_Dict.items():
            ...
            if sr_Ip != '0.0.0.0':
                ...
                # Connect to an SSH server and authenticate to it
                client.connect(hostname=sr_Ip, username="xxxx", password="xxxx")
                ...
                if channel.recv(1024).decode('utf-8').endswith('>'):
            	    ...
            	    # Append port info into list
                        user_Info[num].append(buff.split('\r\n')[-3].split()[-1])
        ...
        for sr_Ip, user_Info in sr_Dict.items():
            for num in range(len(user_Info)):
                final.write('{}\t{}\t{}\t{}\t{}\t{}\n'.format(user_Info[num][1], user_Info[num][3], sr_Ip, user_Info[num][4], user_Info[num][2], user_Info[num][0]))
